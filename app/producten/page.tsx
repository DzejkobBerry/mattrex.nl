    ...
    <main className="pt-20">
      ...
      <section className="bg-gradient-to-br from-primary/10 to-secondary/10 py-20">
        <Container>
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-5xl font-bold text-secondary mb-6">Onze Producten</h1>
      ...
      {productCategories.map((category, catIndex) => (
        <section
          key={catIndex}
          className={
            catIndex % 2 === 0 ? 'py-12 md:py-20 bg-white' : 'py-12 md:py-20 bg-gray-50'
          }
        >
          <Container>
            <div className="flex items-center justify-center mb-12">
              ...
              <h2 className="text-4xl font-bold text-secondary">{category.category}</h2>
            </div>

            <div
              className={`grid grid-cols-1 md:grid-cols-2 ${
                category.category === 'Energieopslag (Diensten)'
              ...
              {category.products.map((product, index) => (
                ...
                >
                  ...
                  <div className="p-6 space-y-4">
                    <div>
                      <h3 className="text-2xl font-bold text-secondary mb-1">{product.name}</h3>
                    ...
                    <div className="flex flex-wrap justify-center gap-4 mt-6">
                      ...
                      <Link href="/contact">
                        <Button size="lg" className="px-8">Koop Nu</Button>
                      </Link>
                    </div>
      ...
      <section className="py-12 md:py-20 bg-gradient-to-br from-primary to-secondary text-white">
        <Container>
          <div className="max-w-3xl mx-auto text-center space-y-6">
            <h2 className="text-4xl font-bold">Niet Zeker Welk Systeem Past Bij U?</h2>
